...
d3.csv("src/data/stock/global_indices_cum_growth.csv", d => {
  ...
  // Prepare scales, color, line generator
  ...
  // ANIMATE LINES (only transition dashoffset)
  ...
  // index dropdown from the dataset's country indices
